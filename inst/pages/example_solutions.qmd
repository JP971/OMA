...
getUnique(tse, "Phylum")

# Agglomerate by rank and shows # of rows
tse_agglomerated <- agglomerateByRank(tse, "Phylum")
...
tse_allranks <- agglomerateByRanks(tse, "Phylum")
altExpNames(tse_allranks)
altExp(tse_allranks, "Phylum")

# Agglomerate by prevalence
tse_prevalence <- agglomerateByPrevalence(tse)
altExp(tse) <- agglomerateByPrevalence(tse)

# Shows column variables and chooses one
colData(tse)
tse_variable <- agglomerateByVariable(tse, "SampleType", by = "cols")
```
