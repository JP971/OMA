...
tse <- transformAssay(tse, assay.type = "counts", method = "relabund")
...
# Agglomerate data by rank
tse <- agglomerateByRank(tse)

# Transform assay by taxonomy rank
...
tse <- transformAssay(tse, assay.type = "counts", method = "philr",
                MARGIN = 1L, pseudocount = TRUE)
